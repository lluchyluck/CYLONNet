        ...
        <div class="profile" id="profile">
            <div class="profile-pic-container">
                <img src="<?php if ($_SESSION["login"] === true)
                    echo "/CYLONNet/assets/images/profile" . $_SESSION["icon"];
                else
                    echo "/CYLONNet/assets/images/profile/icon.gif"; ?>" alt="Profile picture" class="profile-pic">
    ...
    <script>
        ...
        <?php else: ?>
            document.addEventListener("DOMContentLoaded", () => {
                    ...
                    $('#rank-badge').attr('src', '/CYLONNet/assets/images/ranks/rank1.png');
                    $('#rank-badgee').attr('src', '/CYLONNet/assets/images/ranks/rank1.png');
                });
        <?php endif; ?>
