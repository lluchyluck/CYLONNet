...
<body>
  ...
  <div class="main-container">
    ...
    <main>
      ...
      <section id="introduccion" class="box" style="width: 1150px">
        <h2>Introducción</h2>
        <p>
      ...
      <section id="ade" class="box" style="width: 1150px">
      ...
      <!-- Sección de Misiones -->
      <section id="misiones" class="box" style="width: 1150px">
        <h2>Misiones</h2>
        <article>
      ...
      <section id="Developer" class="box" style="width: 1150px">
        <h2>Crear Misión</h2>
        <article>
...
CMD ["/init.sh"]
      ...
      <!-- Sección de Contacto -->
      <section id="contacto" class="box" style="width: 1150px">
        <h2>Contacto</h2>
        <p>
